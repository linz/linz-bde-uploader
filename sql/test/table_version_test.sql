...
CREATE DATABASE table_version_unit1 WITH OWNER = postgres ENCODING = 'UTF8';

\connect table_version_unit1

\i /usr/share/linz-bde-uploader/sql/table_version_tables.sql
\i /usr/share/linz-bde-uploader/sql/table_version_functions.sql

SET SEARCH_PATH = public, table_version;

--CREATE EXTENSION pgtap;
\i /usr/share/postgresql/9.0/contrib/pgtap.sql
...
SELECT has_function( 'table_version', 'ver_complete_revision', NULL  );
...
SELECT has_function( 'table_version', 'ver_get_last_revision', NULL  );
...
SELECT has_function( 'table_version', 'ver_get_versioned_tables', NULL  );
...
DROP DATABASE table_version_unit1;
